...
impl Deezer {
    ...
    fn call_deserialize_gw_request_with_params<T: DeserializeOwned>(&self, method: &str, params: HashMap<&str, String>) -> Result<T, DeezerError> {
        let response: Response = match self.gw_method_call_params(method, params) {
            Ok(r) => r,
            Err(err) => return Err(DeezerError::RequestError(err)),
        };
    ...
    fn call_deserialize_api_request<T: DeserializeOwned>(&self, url_path: &str) -> Result<T, DeezerError> {
    ...
    fn call_deserialize_api_request_as_vec<T: DeserializeOwned>(&self, url_path: &str) -> Result<Vec<T>, DeezerError> {
    ...
    pub fn gw_songs_from_album(&self, album_id: u64) -> Result<models::gw::SongListData, DeezerError> {
        let params: HashMap<&str, String> = [("alb_id", album_id.to_string())].into();
        self.call_deserialize_gw_request_with_params("song.getListByAlbum", params)
    }
    ...
    pub fn track_from_isrc(&self, isrc: &str) -> Result<models::api::MainTrack, DeezerError> {
        self.call_deserialize_api_request(format!("track/isrc:{}", isrc).as_str())
    }

    pub fn album(&self, album_id: u64) -> Result<models::api::MainAlbum, DeezerError> {
        self.call_deserialize_api_request(format!("album/{}", album_id).as_str())
    }

    pub fn album_from_upc(&self, upc: u64) -> Result<models::api::MainAlbum, DeezerError> {
    ...
    pub fn album_tracks(&self, album_id: u64) -> Result<Vec<models::api::Track>, DeezerError> {
        self.call_deserialize_api_request_as_vec(format!("album/{}/tracks", album_id).as_str())
    }

    pub fn artist(&self, artist_id: u64) -> Result<models::api::Artist, DeezerError> {
        self.call_deserialize_api_request(format!("artist/{}", artist_id).as_str())
    }

    pub fn artist_albums(&self, artist_id: u64) -> Result<Vec<models::api::Album>, DeezerError> {
        self.call_deserialize_api_request_as_vec(format!("artist/{}/albums", artist_id).as_str())
    }

    pub fn artist_top_tracks(&self, artist_id: u64) -> Result<Vec<models::api::Track>, DeezerError> {
        self.call_deserialize_api_request_as_vec(format!("artist/{}/top", artist_id).as_str())
    }

    pub fn artist_related_artists(&self, artist_id: u64) -> Result<Vec<models::api::RelatedArtist>, DeezerError> {
        self.call_deserialize_api_request_as_vec(format!("artist/{}/related", artist_id).as_str())
    }

    pub fn artist_radio(&self, artist_id: u64) -> Result<Vec<models::api::Track>, DeezerError> {
        self.call_deserialize_api_request_as_vec(format!("artist/{}/radio", artist_id).as_str())
    }

    pub fn artist_playlists(&self, artist_id: u64) -> Result<Vec<models::api::Playlist>, DeezerError> {
        self.call_deserialize_api_request_as_vec(format!("artist/{}/playlists", artist_id).as_str())
    }
    ...
    pub fn editorial_from_genre(&self, genre_id: u64) -> Result<models::api::Editorial, DeezerError> {
        self.call_deserialize_api_request(format!("editorial/{}", genre_id).as_str())
    }
    ...
    pub fn genre(&self, genre_id: u64) -> Result<models::api::Editorial, DeezerError> {
        self.call_deserialize_api_request(format!("genre/{}", genre_id).as_str())
    }

    pub fn genre_artists(&self, genre_id: u64) -> Result<Vec<models::api::Artist>, DeezerError> {
        self.call_deserialize_api_request_as_vec(format!("genre/{}/artists", genre_id).as_str())
    }

    pub fn genre_radios(&self, genre_id: u64) -> Result<Vec<models::api::Radio>, DeezerError> {
        self.call_deserialize_api_request_as_vec(format!("genre/{}/radios", genre_id).as_str())
    }
    ...
    pub fn radio(&self, radio_id: u64) -> Result<models::api::Radio, DeezerError> {
        self.call_deserialize_api_request(format!("radio/{}", radio_id).as_str())
    }

    pub fn radio_tracks(&self, radio_id: u64) -> Result<Vec<models::api::Track>, DeezerError> {
        self.call_deserialize_api_request_as_vec(format!("radio/{}/tracks", radio_id).as_str())
    }

    pub fn radio_genres(&self) -> Result<Vec<models::api::GenreRadios>, DeezerError> {
